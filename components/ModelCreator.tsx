      ...
      <div className="mx-auto max-w-6xl">
        <div className="grid items-end gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-16">
          ...
          <div className="studio-window overflow-hidden rounded-[28px] border border-black/5">
            ...
            <div className="grid min-h-[360px] grid-cols-[52px_1fr_148px] bg-[#eceaee]">
              <aside className="flex flex-col items-center gap-3 border-r border-black/5 py-5 text-[10px] uppercase tracking-[0.16em] text-black/35">
              ...
              <div className="relative grid place-items-center">
                <div className="absolute inset-8 rounded-[32px]" />
                <div className="wire-spin h-40 w-40">
                  <svg viewBox="0 0 160 160" className="h-full w-full" aria-hidden>
                    ...
                    <ellipse cx="80" cy="80" rx="20" ry="54" fill="none" stroke="#8a8494" strokeWidth="1" />
              ...
              <aside className="space-y-4 border-l border-black/5 p-4 text-[11px] text-black/45">
                <div>
